...
class TestBandwidthDynamicTimes(unittest.TestCase):
    def test_bw_dynamic_times_enumeration_and_variants(self):
        ...
        self.assertEqual(res[expanded], [8, 12])  # cpu doubles; bw sums elements at level 1
